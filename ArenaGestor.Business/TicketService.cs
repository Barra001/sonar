...
namespace ArenaGestor.Business
{
    public class TicketService : ITicketService
    {
        ...
        public Ticket BuyTicket(string token, TicketBuy ticketBuy)
        {
            ...
            List<SnackBuyId> newSnacks = new List<SnackBuyId>();
            if (ticketBuy.Snacks != null && ticketBuy.Snacks.Any())
            {
                foreach (var snack in ticketBuy.Snacks)
                {
                    newSnacks.Add(new SnackBuyId
                    {
